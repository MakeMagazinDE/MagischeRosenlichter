...
typedef struct xCOMMAND_INPUT_LIST
{
   ...
   /// Pointer to the next command entry in list
...
BaseType_t xReturn = pdFAIL;
   ...
   vPortCPUInitializeMutex(&cs_mutex);
